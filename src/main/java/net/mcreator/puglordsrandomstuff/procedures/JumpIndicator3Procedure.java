...
public class JumpIndicator3Procedure {
	public static boolean execute(Entity entity) {
		...
		if (((entity instanceof LivingEntity _entGetArmor ? _entGetArmor.getItemBySlot(EquipmentSlot.FEET) : ItemStack.EMPTY).getItem() == PuglordsRandomStuffModItems.ENHANCED_NETHERITE_BOOTS.get()
				...
				&& (entity.getCapability(PuglordsRandomStuffModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new PuglordsRandomStuffModVariables.PlayerVariables())).jumpnumber == 1) {
			return true;
		}
		return false;
	}
