...
import net.mcreator.puglordsrandomstuff.procedures.JumpKeyOnKeyPressedProcedure;
...
public class JumpKeyMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			JumpKeyOnKeyPressedProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		PuglordsRandomStuffMod.addNetworkMessage(JumpKeyMessage.class, JumpKeyMessage::buffer, JumpKeyMessage::new, JumpKeyMessage::handler);
	}
}
